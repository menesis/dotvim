...
"
" BUGS:
" - hitting Ctrl+C at the wrong time may result in your buffer contents
"   getting replaced with the contents of your error list, with no undo
"
...
if !exists("g:pcs_max_win_height")
    let g:pcs_max_win_height = 5
endif
...
class VimQuickFix(object):
    ...
    def max_height(self):
        if vimfunc.exists("g:pcs_max_win_height"):
            return int(vim.eval('g:pcs_max_win_height'))
        else:
            return 10
