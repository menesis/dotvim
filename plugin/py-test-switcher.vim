...
" Installation
" ------------
" Copy this file and py_test_switcher.py to $HOME/.vim/plugin directory.
"
" If you vim is compiled without Python support, older and less clever
" vimscript fallback code will be used.
"
"
" Usage
" -----
...
if has('python')
    ...
    python if os.path.expanduser('~/.vim/plugin') not in sys.path:
